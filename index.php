  ...
  <div class="wrapper">
    <div id="parent">
      <div class="typewriter">
        <h1 style="width:fit-content">Shorten Your URL</h1>
      </div>
    </div>
    ...
    ?>
      <div class="statistics">
        ...
        ?>
        <span style="color:white">Total Links: <span style="color:white"><?php echo end($res) ?></span> & Total Clicks: <span style="color:white"><?php echo $total ?></span></span>
      ...
      <div class="urls-area">
        ...
        ?>
          <div class="data">
            ...
            <li style="color:white"><?php echo $row['clicks'] ?></li>
